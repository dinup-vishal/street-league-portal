...
import SchedulerScreen from '../../features/scheduler/components/SchedulerScreen';
...
const SchedulerPage: React.FC = () => {
  ...
  return (
    <>
      {/* If a cohort is selected, show full scheduler screen */}
      {selectedCohort ? (
        <SchedulerScreen cohort={selectedCohort} />
      ) : (
        /* Otherwise show cohort list */
